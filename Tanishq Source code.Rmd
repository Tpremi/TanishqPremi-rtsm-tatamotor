...
stock_price=na.omit(stock_data$TATAMOTORS.NS$TATAMOTORS.NS.Adjusted)
#pnj_price

#stock_price = TATAMOTORS.NS$TATAMOTORS.NS.Close # Adjusted Closing Price
